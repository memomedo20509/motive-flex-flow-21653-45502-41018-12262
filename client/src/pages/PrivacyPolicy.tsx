              ...
              <div className="space-y-8 text-muted-foreground leading-relaxed">
                ...
                <div>
                  ...
                  <ul className="list-disc pr-6 space-y-2 mt-4">
                    ...
                    <li>الرسائل التي ترسلها إلى المستشار الذكي وتقييمك لردوده</li>
                  </ul>
                </div>
                ...
                <div>
                  ...
                  <p>
                    قد نحفظ محادثة المستشار الذكي وربطها بمعرّف جلسة لتحسين جودة
                    الإجابات ومتابعة طلبك إذا اخترت التواصل معنا. تُعالج الرسائل
                    بواسطة مزود خدمة ذكاء اصطناعي لتوليد الرد، لذلك ننصح بعدم
                    مشاركة كلمات المرور أو الأسرار التجارية أو أي بيانات حساسة
                    لا يحتاجها السؤال.
                  </p>
                </div>
                ...
                <div>
                  ...
                  <ul className="list-disc pr-6 space-y-2 mt-4">
                    ...
                    <li dir="ltr">الهاتف: +966 50 705 1401</li>
                  </ul>
                </div>
              </div>
            </CardContent>
