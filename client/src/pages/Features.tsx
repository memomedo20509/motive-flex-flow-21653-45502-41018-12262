  ...
  const features = [
    ...
    },
    {
      ...
      benefits: [
        ...
        "إشعارات ترسل للعميل عن كل مرحلة تصنيع",
        "تدوين الملاحظات الداخلية الخاصة بالتصنيع",
        "تأكيد تسليم مشروع العميل رقمياً",
    ...
    },
    {
      ...
      benefits: [
        ...
        "إشعارات ترسل للعميل عن كل مرحلة تركيب",
        "تدوين الملاحظات الداخلية الخاصة بالتركيب",
    ...
    },
    {
      ...
      title: "إدارة الفنيين",
      description:
        "نظام شامل لإدارة الفنيين ومقاولين الباطن مع عرض المهام اليومية والحضور ومواقع العمل.",
      benefits: [
        "قاعدة بيانات كاملة للفنيين",
        "توزيع المهام اليومية",
        "حساب الأجور والحوافز",
        "تتبع المواقع الجغرافية للفنيين",
        "متابعة إنتاجية وتكاليف مقاولين الباطن",
      ],
    },
    {
      icon: FileText,
    ...
    },
    {
      ...
      title: "قائمة الأسعار",
      description:
        "أنشئ قائمة أسعار منتجاتك مع المواصفات والصور، وخلّي تحديث الأسعار أسرع وأسهل مع تغيّرات السوق.",
      benefits: [
        "إنشاء قائمة أسعار للمنتجات مع المواصفات والصور",
        "تحديث سريع للأسعار عند تغيّر السوق",
        "مشاركة/عرض القائمة بسهولة داخل الشركة",
        "تقليل أخطاء التسعير وتضارب النسخ بين الموظفين",
      ],
    },
  ];
